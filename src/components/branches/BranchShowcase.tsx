  ...
  return (
    <div className="w-full relative py-12">
      <div className="text-center mb-16 px-4">
        ...
        <div className="w-24 h-1 bg-gradient-to-r from-[#E50914] to-[#8a0000] mx-auto mb-6" />
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        {branches.map((branch, idx) => (
          <motion.div
            ...
            className="group relative bg-[#121212] border border-[#E50914]/20 rounded-2xl overflow-hidden hover:border-[#E50914]/50 transition-all duration-300 shadow-2xl"
          >
            {/* Video Container */}
            <div
              className="relative h-[300px] md:h-[400px] w-full bg-[#1A1A1A] overflow-hidden cursor-pointer"
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#E50914] via-transparent to-transparent opacity-90 pointer-events-none" />

              <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10 pointer-events-none">
                <div className="w-16 h-16 bg-[#E50914]/80 backdrop-blur-sm rounded-full flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300 shadow-[0_0_20px_rgba(229,9,20,0.3)]">
                  <PlayCircle className="w-8 h-8 text-white ml-1" />
                </div>
              </div>

              <div className="absolute bottom-4 left-4 z-20 pointer-events-none">
                <span className="bg-[#E50914]/10 backdrop-blur-md border border-[#E50914]/20 text-[#E50914] px-3 py-1.5 text-[10px] uppercase tracking-widest rounded-full font-bold flex items-center gap-2 drop-shadow-lg shadow-[0_0_15px_rgba(229,9,20,0.15)]">
            ...
            <div className="p-8 relative">
              <a
                ...
                className="absolute top-0 right-8 -translate-y-1/2 p-4 bg-[#1A1A1A] border border-[#E50914]/20 rounded-full group-hover:bg-[#E50914] transition-colors duration-300 block shadow-xl"
              >
                <MapPin className="w-6 h-6 text-[#E50914] group-hover:text-white transition-colors" />
              </a>
              ...
              <h3 className="font-bebas-neue text-4xl tracking-wide uppercase mb-3 text-white">{branch.name}</h3>
              <p className="text-[#E50914] text-[13px] uppercase tracking-widest font-semibold mb-4">{branch.highlight}</p>
              <Link href="/gallery">
                <button className="flex items-center gap-2 text-[#E50914] font-semibold uppercase tracking-wider text-sm group/btn">
