...
export const AnimatedTestimonials = ({
    ...
    return (
        <div className={cn("max-w-sm md:max-w-4xl ml-0 px-4 md:px-8 lg:px-12 py-20", className)}>
            <div className="relative grid grid-cols-1 md:grid-cols-2 gap-20">
                ...
                <div className="flex justify-between flex-col py-4">
                    ...
                    >
                        ...
                        <motion.p className="text-lg text-[#B3B3B3] mt-8 italic font-light leading-relaxed">
                    ...
                    <div className="flex gap-4 pt-12 md:pt-0">
                        <button
                            onClick={handlePrev}
                            className="h-10 w-10 rounded-full bg-white/5 border border-white/10 hover:bg-[#E50914] hover:text-black flex items-center justify-center group/button transition-all"
                        >
